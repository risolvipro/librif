...
image_path = os.path.join(working_dir, input_file)
...
if png_output:
    output_filename = os.path.join(output_dir, filename_no_ext + "-grayscale.png")
...
if os.path.isdir(output_dir):
    ...
    if compressed:
        extension = "rifc"
    output_filename = filename_no_ext + "." + extension
